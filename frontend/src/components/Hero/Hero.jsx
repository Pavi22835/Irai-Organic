...
const Hero = () => {
  return (
    <section id="home" className="relative overflow-hidden bg-[#F8F7F2] min-h-screen md:h-screen flex items-center py-20 md:py-0">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#F8F7F2] via-[#F8F7F2]/95 to-[#F8F7F2]/30 md:via-[#F8F7F2]/85 md:to-transparent" />
      </div>
        ...
        <div className="max-w-xl lg:max-w-2xl">
          ...
          >
            <div className="mb-8 space-y-6">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-[72px] font-extrabold leading-tight tracking-[-0.04em] text-[#1C2C1A]">
                Pure by Nature,
                <br />
            ...
            <div className="mt-12 flex flex-col gap-4 rounded-[28px] bg-white/75 p-4 shadow-[0_18px_35px_rgba(15,23,42,0.05)] backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between sm:gap-0">

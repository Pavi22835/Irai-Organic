...
const CategoryCard = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.08),_transparent_55%)] pointer-events-none" />
      ...
      {/* Icon Frame */}
      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#5b7b2f] via-[#3e5b24] to-[#21351b] shadow-inner flex items-center justify-center mb-5 group-hover:scale-105 group-hover:bg-gradient-to-br group-hover:from-[#7cb342] group-hover:to-[#5b7b2f] transition-all duration-300">
